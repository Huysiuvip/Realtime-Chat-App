...
const ChatWindowBody = () => {
  const {activeConversationId, conversations, messages:allMessage,fetchMessages} = useChatStore();
  ...
  const fetchMoreMessages = async () =>{
    ...
    try {
      ...
      console.error("Error fetching more dataMessage", error)
    }
  }
